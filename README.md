...
- **Procedural Node Generation:** I built a system to read MIDI files and convert them into JSON data. This allowed us to generate note charts automatically, saving a massive amount of time that would have been spent placing notes by hand.
